...
export default function PortalMayorista() {
  ...
  const menuItems = [
    ...
    { id: "listas", label: "Listas WP", icon: Share2, color: "hover:bg-orange-500/10 hover:text-orange-400", activeBg: "bg-orange-500/10 text-orange-400 border-orange-500/50 shadow-[0_0_15px_-3px_rgba(249,115,22,0.15)]", ver: esDueñoOAdmin || (usuarioActual?.accesos?.listas ?? true) },
    { id: "clientes", label: "Clientes", icon: Users, color: "hover:bg-purple-500/10 hover:text-purple-400", activeBg: "bg-purple-500/10 text-purple-400 border-purple-500/50 shadow-[0_0_15px_-3px_rgba(168,85,247,0.15)]", ver: esDueñoOAdmin || (usuarioActual?.accesos?.clientes ?? false) },
