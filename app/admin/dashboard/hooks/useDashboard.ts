...
export function useDashboard() {
  ...
  const [invoiceType, setInvoiceType] = useState<"VENTA" | "PRESUPUESTO" | "FACTURA C" | "ETIQUETA" | "REMITO REPARACION">("VENTA")
